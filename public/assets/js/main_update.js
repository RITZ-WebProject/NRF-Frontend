	...
	"use strict";
		...
		function gmap() {
	        var mapOptions = {
	            ...
	            center: new google.maps.LatLng(52.486243, -1.890401), // New York
	        ...
	        var marker = new google.maps.Marker({
	            position: new google.maps.LatLng(52.486243, -1.890401),
	            map: map,
		...
		$('.port-popup,.port-popupp').magnificPopup({
            ...
            // Add close button to Magnific Popup
            markup: '<div class="mfp-close"></div>',
            callbacks: {
                // Set click event listener on close button
                open: function() {
